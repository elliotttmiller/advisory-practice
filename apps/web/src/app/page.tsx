          ...
          <div className="container-wide">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-secondary-900 mb-6">
                Your Trusted Partner in <span className="text-gradient">Financial Success</span>
              </h1>
              <p className="text-lg md:text-xl text-secondary-600 mb-8">
                Expert financial advisory services with enterprise-grade security and full
                regulatory compliance. Build your wealth with confidence.
              </p>
          ...
          <div className="container-wide">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-secondary-600 max-w-2xl mx-auto">
                From wealth management to retirement planning, we provide personalized financial
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <article className="card hover:shadow-md transition-shadow">
                ...
                <p className="text-secondary-600">
                  Comprehensive portfolio management tailored to your risk tolerance and financial
                  objectives.
                </p>
              </article>
              ...
              <article className="card hover:shadow-md transition-shadow">
                ...
                <p className="text-secondary-600">
                  Strategic planning to secure your financial future and ensure a comfortable
                  retirement.
                </p>
              </article>
              ...
              <article className="card hover:shadow-md transition-shadow">
                ...
                <p className="text-secondary-600">
                  Expert guidance on investment strategies aligned with your long-term financial
                  goals.
                </p>
              </article>
        ...
        <div className="container-wide">
          ...
          <div className="border-t border-secondary-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4 text-secondary-400 text-sm">
              <span className="compliance-badge bg-secondary-800 text-secondary-300">
                SEC Registered
              </span>
              <span className="compliance-badge bg-secondary-800 text-secondary-300">
                FINRA Member
