      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-secondary-200 min-h-[calc(100vh-4rem)]">
          <nav className="p-4 space-y-1">
            <Link href="/dashboard" className="flex items-center gap-3 px-3 py-2 text-primary-600 bg-primary-50 rounded-lg font-medium">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
              Dashboard
            </Link>
            <Link href="/dashboard/clients" className="flex items-center gap-3 px-3 py-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
              Clients
            </Link>
            <Link href="/dashboard/documents" className="flex items-center gap-3 px-3 py-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
              </svg>
              Documents
            </Link>
            <Link href="/dashboard/compliance" className="flex items-center gap-3 px-3 py-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/dashboard/marketing" className="flex items-center gap-3 px-3 py-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" />
              </svg>
              Marketing
            </Link>
            <Link href="/dashboard/reports" className="flex items-center gap-3 px-3 py-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
              Reports
            </Link>
            <Link href="/dashboard/audit-logs" className="flex items-center gap-3 px-3 py-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/dashboard/settings" className="flex items-center gap-3 px-3 py-2 text-secondary-600 hover:text-secondary-900 hover:bg-secondary-50 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/dashboard/compliance" className="text-sm text-primary-600 hover:text-primary-700">
                  View All →
                </Link>
              </div>
              <div className="space-y-4">
                {[
                  { id: 1, type: 'Marketing', title: 'Q4 Newsletter Draft', status: 'SEC Review', daysOld: 2 },
                  { id: 2, type: 'Document', title: 'Client Agreement Template', status: 'Legal Review', daysOld: 1 },
                  { id: 3, type: 'Communication', title: 'Social Media Post', status: 'Compliance Review', daysOld: 0 },
                ].map((item) => (
                  <div key={item.id} className="flex items-center justify-between py-2 border-b border-secondary-100 last:border-0">
                    <div>
            ...
            <div className="card">
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/dashboard/audit-logs" className="text-sm text-primary-600 hover:text-primary-700">
                  View All →
                </Link>
              </div>
              <div className="space-y-4">
                {[
                  { id: 1, action: 'Client profile updated', user: 'Sarah Johnson', time: '2 min ago' },
                  { id: 2, action: 'Document approved', user: 'Mike Chen', time: '15 min ago' },
                  { id: 3, action: 'New lead captured', user: 'System', time: '1 hr ago' },
                  { id: 4, action: 'Compliance check passed', user: 'Auto-Review', time: '2 hrs ago' },
                ].map((item) => (
                  <div key={item.id} className="flex items-center justify-between py-2 border-b border-secondary-100 last:border-0">
                    <div>
