      ...
      <div className="w-full max-w-md px-4">
        ...
        <div className="card">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-secondary-900">Advisor Sign In</h1>
            <p className="text-secondary-600 mt-1">Access your advisor dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                href="/forgot-password?type=advisor"
