...
interface DashboardLayoutProps {
  ...
  userRole?: 'advisor' | 'admin' | 'compliance_officer';
...
const navigationItems = [
  {
    ...
    roles: ['advisor', 'admin', 'compliance_officer'],
  },
  {
    name: 'Clients',
...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-secondary-50">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <span className="text-sm font-medium text-secondary-600">
                {userRole === 'admin' ? 'Admin Dashboard' : 'Advisor Portal'}
              </span>
            </div>
            <div className="flex items-center gap-4">
              <button
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-64 bg-white border-r border-secondary-200 min-h-[calc(100vh-4rem)] sticky top-16">
            ...
            {filteredNavigation.map((item) => {
              ...
              return (
                ...
                >
                  {item.icon}
                  {item.name}
                  {item.showBadge && pendingReviews > 0 && (
